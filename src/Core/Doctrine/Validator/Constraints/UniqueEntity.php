...
namespace App\Core\Doctrine\Validator\Constraints;

use App\Core\Doctrine\Validator\UniqueEntityValidator;
...
class UniqueEntity extends Constraint
{
    ...
    /** @var string[] ['assertField' => 'entityField'] or ['entityField'] */
    public array $fields = [];
